...
import { CreatedAtDto, CursorPaginationResponseDto } from 'src/common/dto'
...
export class GetLikesResponseDto extends IntersectionType(CursorPaginationResponseDto) {
    @ApiProperty({
