        ...
        <section className='w-full flex flex-col items-center mt-20 p-5'>
            <div className='w-full max-w-4xl flex flex-col items-center mb-20'>
                <input
                    ...
                    className='w-full h-20 px-6 py-4 rounded-2xl border border-gray-300 shadow focus:outline-none focus:ring-2 focus:ring-blue-400 hover:scale-102 transition-transform duration-200'
                />
            </div>
            {isLoading ? (
